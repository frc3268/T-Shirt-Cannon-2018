...
public class OI {
	...
	public static Button raiseButton = new JoystickButton(stick, 4);
	public static Button lowerButton = new JoystickButton(stick, 5);
	public static Button shootButton = new JoystickButton(stick, 12);
